...
if (isset($_POST['perbarui'])) {
	...
	$query = mysqli_query($conn, "UPDATE `login` SET `namalengkap`='$namalengkap',`email`='$email',`notelp`='$notelp',`alamat`='$alamat' WHERE `userid`='$userid'");
	...
	<div class="agileits_header">
		<div class="container">
			<div class="w3l_offers">
				<p>CINTAI PRODUK DALAM NEGRI, CINTAI KARYANYATA.ID, BELANJA SEKARANG!</p>
			</div>
		...
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>KARYANYATA.ID</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@email">KARYANYATA.ID@gmail.com</a></li>
				...
				<div class="col-md-3 w3_footer_grid">
					<h3>Tentang Kami</h3>
					<ul class="info">
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="about.html">Profil Perusahaan</a></li>
