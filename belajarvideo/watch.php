				...
				<div class="row">
					<div class="col-md-8">
						<div class="d-block w-100 vid-watch-feild bg-dark border border-dark p-0" style="border-width: 2px">
							<video class="w-100" autoplay="true" controls id="vid-watch">
								<source src="<?php echo "assets/video/videos/".$video_path ?>">
							</video>
						</div>
						...
						<div class="col-md-12">
							<div class="d-flex w-100 align-items-center">
								<?php if(!empty($avatar)): ?>
									<img src="assets/video/<?php echo $avatar ?>" class="rounded-circle" width="50px" height="50px" alt="">
								<?php else: ?>
					...
					<div class="col-md-4 border-left">
						...
						<a class="d-flex w-100 border-bottom pb-1 suggested" href="index.php?page=watch&code=<?php echo $row['code'] ?>">
							<div class="img-thumbnail suggested-img border-dark border" poster="assets/video/thumbnail/<?php echo $row['thumbnail_path'] ?>">
								<video class="img-fluid" id="<?php echo $row['code'] ?>" muted>
									<source src="assets/video/videos/<?php echo $row['video_path'] ?>" alt="" >
								</video>
							</div>
