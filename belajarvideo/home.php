							...
							<div class="col-md-3 py-2">
								<div class="card bg-dark">
								  ...
								  <a class="card-img-top d-flex justify-content-center bg-dark border-dark img-thumbnail w-100 p-0 vid-item" href="index.php?page=watch&code=<?php echo $row['code'] ?>">
									<video id="<?php echo $row['code'] ?>" class="img-fluid" <?php echo !empty($row['thumbnail_path']) ? "poster='assets/video/thumbnail/".$row['thumbnail_path']."'" : '' ?> muted>
										<source src="<?php echo !empty($row['video_path']) ? "assets/video/videos/".$row['video_path'] : '' ?>">
									</video>
