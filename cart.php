	...
	<div class="agileits_header">
		<div class="container">
			<div class="w3l_offers">
				<p>CINTAI PRODUK DALAM NEGRI, CINTAI KARYANYATA.ID<a href="products.html">BELANJA SEKARANG!</a></p>
			</div>
			...
			<nav class="navbar navbar-default">
							...
							<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
								<ul class="nav navbar-nav">
									...
									<li><a href="belajarvideo/index.php">Video Perawatan </a></li>
			...
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						...
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@email">KARYANYATA.ID@email</a></li>
